...
function optionSelect(answer){
    ...
    // After Selecting One Option All Option Disabled
...
function showResult(){
    ...
    if(score > 7){
        ...
        let scoreTag = `<span>Great! You Scored ` + score + ` Out Of `+ questions.length + ` 🔥</span>`
        scoreText.innerHTML = scoreTag;        
    } else {
